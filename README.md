...
# 因 Unity 犯贱，我决定不再更新相关插件。实不是我将其过迁怒于各位开发者朋友，只是想尽快完成自己的项目，早日脱离 Unity 另寻他路。UE 对我过于冗余，况且一朝被蛇咬十年怕井绳，有 Unity 开此先例，我已无法信任闭源的免费引擎。我欲在项目完成之后，学习引擎与图形 API ，方可灵活运用其他开源引擎而不再受人羁绊。我所分享的插件本为项目所用，经考虑通用适配细细打磨后与开发者朋友们分享。再无余力顾此，望各位见谅！
...
# 安装指定版本
openupm add com.gsr.tmproplayer@1.1.6
```
...
```shell
https://github.com/Giresharu/TMPro-Player.git?path=Assets#1.1.6
```
